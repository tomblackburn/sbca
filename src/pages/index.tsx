	...
	return (
		<>
			<main className="bg-dark-layer-2 min-h-screen">
				...
				<div className="relative overflow-x-auto px-6 pb-10 text-md text-left text-gray-100 dark:text-gray-300 sm:w-7/12 w-full max-w-[1200px] mx-auto" >
				...
				<table className='text-md text-left text-gray-500 dark:text-gray-400 sm:w-7/12 w-full max-w-[1200px] mx-auto table-auto '>
					<thead className='text-md text-gray-700 uppercase dark:text-gray-400 border-b '>
					<tr>
						<th scope='col' className='px-6 py-3 placeholder:font-medium'>
						Status
						</th>
